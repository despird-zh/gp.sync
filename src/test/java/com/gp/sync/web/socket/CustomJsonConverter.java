 ...
 * @since 4.0
 */
public class CustomJsonConverter extends AbstractMessageConverter {
	 ...
	 * @since 4.1.5
	 */
	public CustomJsonConverter(MimeType... supportedMimeTypes) {
	...
	protected Object convertFromInternal(Message<?> message, Class<?> targetClass, Object conversionHint) {
		...
		try {
			if (payload instanceof byte[]) {
				System.out.println("----XXX: "+ new String((byte[])payload));
				if (view != null) {
